...
var ErrInvalidReservationTime = errors.New("la hora de la reserva debe estar entre 0 y 23")
var ErrInvalidReservationDateFormat = errors.New("el formato de la fecha de la reserva no es válido")
var ErrInvalidReservationDuration = errors.New("la duración de la reserva debe estar entre 0 y 12")
var ErrInvalidReservationDate = errors.New("la fecha de la reserva no puede ser anterior a la fecha actual")
